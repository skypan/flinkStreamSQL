...
CREATE TABLE pres30302700003_2
(
    RowGuid varchar,
    xxdz    varchar,
    primary key (RowGuid)
...
CREATE TABLE pres30302700003_3
(
    RowGuid varchar,
    xxdz    varchar,
    primary key (RowGuid)
...
insert into pres30302700003_2(RowGuid, xxdz, uploadtime, OperateType)
...
insert into pres30302700003_3(RowGuid, xxdz, uploadtime, OperateType)
select rowguid as RowGuid, xxdz, CURRENT_TIMESTAMP as uploadtime, if(OperateType is null, 'Insert', 'Update') as OperateType
from pres30302700001;
